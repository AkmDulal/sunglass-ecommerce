    	 ...
    	 <div class="row align-items-center">	
             <div class="col-md-6">
            	 <div class="newsletter_text text_white">
                     <h3>Subscribe For Exciting Deals and Offers</h3>
 ...
 <footer class="bg_gray">
         ...
         <div class="custom-container">
             <div class="row">
                 <div class="col-lg-4 col-md-12 col-sm-12">
                	 <div class="widget">
                         <div class="footer_logo logo_width d-none">
     ...
     <div class="bottom_footer border-top-tran">
         <div class="custom-container">
             <div class="row">
                 <div class="col-lg-4">
                     <p class="mb-lg-0 text-center">© 2021 All Rights Reserved by name</p>
                 </div>
 ...
 <div class="quick-view-modal">
    ...
    <button class="close-quickview-modal"><i class="ti-close"></i></button>
</div>
