    ...
    <div class="custom-container">
        <div class="row">
            <div class="col-md-9">
                <div class="product-details">
                    ...
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-2">
                            <a href="assets/images/el_img1.jpg">
                                <img src="assets/images/p1.png" alt="product image" />
                            </a>
                            <a href="assets/images/el_img1.jpg">
                                <img src="assets/images/el_img1.jpg" alt="product image" />
                            </a>
                            <a href="assets/images/el_img1.jpg">
                                <img src="assets/images/el_img1.jpg" alt="product image" />
                            </a>
                    ...
                    <div class="product-details-right">
                        ...
                        <div class="product-details-socialshare">
                            ...
                            <ul>
                                ...
                                <li><a class="google-plus" href="#"><i class="ti-youtube"></i></a></li>
                ...
                <div class="col-md-3">
                    <div class="free_shipping_area">
                        <div class="shipping_bolck">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M20.772,10.156l-1.368-4.105C18.995,4.824,17.852,4,16.559,4H7.441C6.148,4,5.005,4.824,4.596,6.051l-1.368,4.105 C2.508,10.459,2,11.171,2,12v5c0,0.753,0.423,1.402,1.039,1.743C3.026,18.809,3,18.869,3,18.938V21c0,0.553,0.447,1,1,1h1 c0.553,0,1-0.447,1-1v-2h12v2c0,0.553,0.447,1,1,1h1c0.553,0,1-0.447,1-1v-2.062c0-0.069-0.026-0.13-0.039-0.195 C21.577,18.402,22,17.753,22,17v-5C22,11.171,21.492,10.459,20.772,10.156z M4,17v-5h16l0.002,5H4z M7.441,6h9.117 c0.431,0,0.813,0.274,0.949,0.684L18.613,10H5.387l1.105-3.316C6.629,6.274,7.011,6,7.441,6z"></path><circle cx="6.5" cy="14.5" r="1.5"></circle><circle cx="17.5" cy="14.5" r="1.5"></circle></svg><div class="shipping_bolck_text"><p>  <b> Free Shipping </b> apply to all orders over $100  </p></div></div><div class="shipping_bolck"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="4"></circle><path d="M13,4.069V2h-2v2.069C7.389,4.522,4.523,7.389,4.069,11H2v2h2.069c0.454,3.611,3.319,6.478,6.931,6.931V22h2v-2.069 c3.611-0.453,6.478-3.319,6.931-6.931H22v-2h-2.069C19.478,7.389,16.611,4.522,13,4.069z M12,18c-3.309,0-6-2.691-6-6s2.691-6,6-6 s6,2.691,6,6S15.309,18,12,18z"></path></svg>
                            <div class="shipping_bolck_text">
                                <p>  Guranteed <b> 100% Organic </b> from natural farmas   </p>
                            </div>
                        </div>
                    </div>

                    <div class="free_shipping_area"><div class="shipping_bolck"><div class="shipping_bolck_text"><p>  Hotline Order: Free 7:00-21:30  </p><span> <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path></svg> 970978-6290 </span><span> <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path></svg> 970978-6290 </span></div></div></div>
