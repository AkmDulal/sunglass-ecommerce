            	 ...
            	 <div class="banner_section shop_el_slider">
                     <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
                         <div class="carousel-inner">
                             ...
                             <img src="assets/images/banner17.jpg" alt=""></img>
                                 <div class="banner_slide_content banner_content_inner">
                                     <div class="col-lg-8 col-10">
                                         <div class="banner_content3 overflow-hidden">
                                             ...
                                             <h2 class="staggered-animation" data-animation="slideInLeft" data-animation-delay="1s">Men's Spring Collection </h2>
                             ...
                             <div class="carousel-item background_bg">
                                <img src="assets/images/banner18.jpg" alt=""></img>
                             </div>
                         </div>
            ...
            <div class="col-lg-3 d-none d-lg-block">
            	 <div class="shop_banner2 el_banner1">
                	 <a href="#" class="hover_effect1">
                    	 <div class="el_title custom_el_title">
                        	 <h6>ACCESSORIES </h6>
                             <span>25% off </span>
                         </div>
                         <img src="assets/images/bn01.png" alt="shop_banner_img6" />
                         <!-- <div class="el_img">
                         </div> -->
                     </a>
                 </div>
            	 ...
            	 <div class="shop_banner2 el_banner1">
                	 <a href="#" class="hover_effect1">
                         ...
                         <img src="assets/images/bn02.png" alt="shop_banner_img6" />
                     </a>
                 </div>
 ...
 <div class="section pb_20 small_pt">
	 <div class="custom-container">
         ...
         <div class="col-md-4 col-sm-6">
            <div class="sale-banner mb-3 mb-md-4">
                <a class="hover_effect1" href="category.php">
                    <img src="assets/images/b_bootm01.jpg" alt="shop_banner_img9">
                </a>
                <a class="btn b_bootm_slider btn-fill-out btn-radius staggered-animation text-uppercase" href="#" data-animation="slideInLeft" data-animation-delay="1.5s">Men's Sunglass </a>
            </div>
        </div>
         ...
         <div class="col-md-4 col-sm-6">
            <div class="sale-banner mb-3 mb-md-4">
                <a class="hover_effect1" href="category.php">
                    <img src="assets/images/b_bootm02.jpg" alt="shop_banner_img9">
                </a>
                <div class="deal_content">
                        <div class="product_info">
                            <h5 class="product_title"><a href="shop-product-detail.html">Full-Rim Wrap Sunglasses </a></h5>
                            <div class="product_price">
                                <span class="price">$68.00 </span>
                                <del>$99.25 </del>
                            </div>
                        </div>
                        <div class="countdown_time" id="countdown">
                            <ul class="countdown_box">
                                <li class="countdown-wrap"><span class="countdown_box" id="days"></span>days</li>
                                <li class="countdown-wrap"><span class="countdown_box" id="hours"></span>Hours</li>
                                <li class="countdown-wrap"><span class="countdown_box" id="minutes"></span>Minutes</li>
                                <li class="countdown-wrap"><span class="countdown_box" id="seconds"></span>Seconds</li>
                            </ul>
                        </div>
                    </div>
             ...
             <div class="col-md-4 col-sm-6">
            	 <div class="sale-banner mb-3 mb-md-4">
                	 <a class="hover_effect1" href="category.php">
                		 <img src="assets/images/b_bootm03.jpg" alt="shop_banner_img9">
                     </a>
                     <a class="btn b_bootm_slider btn-fill-out btn-radius staggered-animation text-uppercase" href="#" data-animation="slideInLeft" data-animation-delay="1.5s">Women's Sunglass </a>
                 </div>
             </div>
         </div>
     </div>
                     ...
                     <div class="col-12">
                         <div class="tab_slider">
                             <div class="tab-pane fade show active" id="arrival" role="tabpanel" aria-labelledby="arrival-tab">
                                 <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"},"1280":{"items": "5"}}'>
                                     <div class="item">
         ...
         <div class="col-md-12">
        	 ...
        	 <div class="col-xl-12">
                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}, "1280":{"items": "5"}}'>
                    <div class="item">
                        <div class="product_wrap">
                            <div class=" hover_effect1">
                                <a class="product_img " href="category.php">
                                    <img src="assets/images/c01.jpg" alt="el_img1" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product_wrap">
                            <div class=" hover_effect1">
                                <a class="product_img" href="category.php">
                                    <img src="assets/images/c02.jpg" alt="el_img1" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product_wrap">
                            <div class=" hover_effect1">
                                <a class="product_img" href="category.php">
                                    <img src="assets/images/c03.jpg" alt="el_img1" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product_wrap">
                            <div class=" hover_effect1">
                                <a class="product_img" href="category.php">
                                    <img src="assets/images/c04.jpg" alt="el_img1" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product_wrap">
                            <div class=" hover_effect1" >
                                <a class="product_img" href="category.php">
                                    <img src="assets/images/c05.jpg" alt="el_img1" />
                                </a>
                            </div>
                        </div>
                    </div>
