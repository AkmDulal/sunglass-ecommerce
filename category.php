         ...
         <div class="row align-items-center">
             ...
             <div class="col-md-6">
                 <ol class="breadcrumb justify-content-md-end">
                     ...
                     <li class="breadcrumb-item active">Product Catagores </li>
                 </ol>
             </div>
         </div>
     </div><!-- END CONTAINER-->
                             ...
                             <div class="product_img">
                                 ...
                                 <div class="product_action_box">
                                     <ul class="list_none pr_action_btn">
                                         ...
                                         <li>
                                             <a title="Quick View" href="#" class="popup-ajax quickview">
             ...
             <div class="col-lg-3 order-lg-first mt-4 pt-2 mt-lg-0 pt-lg-0">
            	 <div class="sidebar">
                     ...
                     <div class="widget">
                         ...
                         <ul class="list_brand" style="padding-left: 20px;">
                             <li>
